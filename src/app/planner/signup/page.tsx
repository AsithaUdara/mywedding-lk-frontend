      ...
      aside={
        <aside className={glassAuthAsideClass}>
          <div>
            ...
            <h2 className={glassAuthTitleClass}>Grow your planning studio</h2>
    ...
    >
      <div className="w-full max-w-2xl">
        <div className="mb-8 text-center lg:hidden">
          ...
          <p className={cn("mt-1", glassAuthTitleClass)}>Planner signup</p>
        </div>

        <GlassAuthCard>
          <div className="mb-6 hidden lg:block">
            <h1 className={glassAuthTitleClass}>Create planner account</h1>
          ...
          <form onSubmit={(e) => void onSubmit(e)} className="space-y-6">
            <div>
              <p className={rf.label}>Your account</p>
            ...
            <div>
              <p className={rf.label}>Business profile</p>
              <div className="mt-4 space-y-4">
                <div>
