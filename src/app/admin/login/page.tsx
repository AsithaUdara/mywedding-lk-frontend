      ...
      <main className="flex flex-1 flex-col items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          <div className="mb-8 text-center lg:hidden">
            ...
            <p className="mt-1 font-playfair text-2xl font-bold text-foreground">Admin sign in</p>
          </div>

          <div className="rounded-3xl border border-border bg-card p-8 shadow-sm sm:p-10">
            <div className="mb-6 hidden lg:block">
              <h1 className="font-playfair text-3xl font-bold text-foreground">Admin sign in</h1>
              <p className="mt-2 text-sm text-muted-foreground">Platform administration</p>
            </div>
